...
const routes = [
    ...
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | components-product-management-product-management-module */ "components-product-management-product-management-module").then(__webpack_require__.bind(null, /*! ./components/product-management/product-management.module */ "./src/app/components/product-management/product-management.module.ts")).then(m => m.ProductManagementModule)
    }
];
...
module.exports = __webpack_require__(/*! C:\Users\Андрей\source\repos\ProductManagement\ProductManagement\Client-Side\src\main.ts */"./src/main.ts");
